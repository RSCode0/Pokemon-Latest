...
class Fight:
    ...
    def draw_pokemons(self):
        ...
        x_base = 120
        y_base = SH - 250
        for i, slot in enumerate(self.player_pokemons_stats):
            ...
            self._draw_hp_bar(pos[0], pos[1] - 30, iw,
                              self.player_pokemons_stats[slot]["stats"]["hp"],
                              self.player_pokemons_base_hp[slot])
        ...
        x_base = SW - 200
        y_base = 80
        for i, name in enumerate(self.ennemi_pokemons_stats):
            ...
            self._draw_hp_bar(pos[0], pos[1] - 30, iw,
                              self.ennemi_pokemons_stats[name]["stats"]["hp"],
                              self.ennemi_pokemons_base_hp[name])
